 ...
 * The DailyApointment class holds information about a 
 * type of date,GregorianCalendar object and description of appointment 
 *  and computes whether given date is a daily occurrence for that specific date
 * @author E Cross
 *
 */
public class DailyAppointment extends Appointment {
	 ...
	 */
	public DailyAppointment(char group, GregorianCalendar d, String describe){
	 ...
	 * @return success returns true if appt is daily occurrence
	 */
